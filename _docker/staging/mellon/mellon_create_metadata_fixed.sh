...
# FIX: Allow openssl to return non-zero exit code due to RANDFILE issue
# The cert and key are still created successfully
...
umask 0022
chmod 644 "$OUTFILE.xml"
chmod 644 "$OUTFILE.cert"
